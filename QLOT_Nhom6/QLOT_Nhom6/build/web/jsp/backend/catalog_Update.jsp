                    ...
                    <div class="col-lg-8">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-lg-10">
                                        <f:form role="form" action="updateCatalog.htm" method="POST" modelAttribute="updateCatalog" enctype="multipart/form-data" >
                                            <div class="form-group">
                                                <label>Mã Thương Hiệu</label>
                                                <f:input path="catalogID" readonly="true" class="form-control" />
                                            </div>
                                            <div class="form-group">
                                                <label>Thương Hiệu</label>
                                                <f:input path="catalogName" class="form-control" />
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label>Mã Loại</label>
                                            <f:input path="parentID" type="number" class="form-control" />
                                            </div>
                                            <div class="form-group">
                                                <label>Ảnh Logo  </label>
                                                <f:input path="imageLogo" type="file" />
                                            </div>
                                            <div class="form-group">
