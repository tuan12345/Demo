                                    ...
                                    <tbody>
                                        <c:forEach var="cl" items="${colors}">
                                            <tr class="odd gradeX">
                                                ...
                                                <td>${cl.colorName}</td>
                                                <td>${cl.status}</td>
                                                <td><a href="initUpdateColor.htm?colorID=${cl.colorID}">Update</a>
                                                    <a href="deleteColor.htm?colorID=${cl.colorID}" onclick="return confirm('Are you sure?')">Delete</a></td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
                                </table>
                            </div>
                            <a href="initInsertColor.htm">Thêm Màu Mới</a>
                            <!-- /.table-responsive -->
                        </div>
                        <!-- /.panel-body -->
                    </div>
