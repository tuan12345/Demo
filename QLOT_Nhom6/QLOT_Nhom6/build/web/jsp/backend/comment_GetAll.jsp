                                    ...
                                    <tbody>
                                        <c:forEach var="cm" items="${comments}">
                                            <tr class="odd gradeX">
                                                ...
                                                <td>${cm.status}</td>
                                                <td><a href="updateComment.htm?userID=${cm.userID}&productID=${cm.productID}" onclick="return confirm('Bạn muốn duyệt bình luận này?')">Approval</a>
                                                    <a href="deleteComment.htm?userID=${cm.userID}&productID=${cm.productID}" onclick="return confirm('Bạn muốn xóa bình luận này?')">Delete</a></td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
                                </table>
