    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Quản Lý Function</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <c:forEach var="fc" items="${functions}">
                                            <tr class="odd gradeX">
                                                <td>${fc.functionID}</td>
                                                <td>${fc.functionName}</td>
                                                <td>${fc.status}</td>
                                                <td><a href="initUpdateFunction.htm?functionID=${fc.functionID}">Update</a>
                                                    <a href="deleteFunction.htm?functionID=${fc.functionID}" onclick="return confirm('Are you sure?')">Delete</a></td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
                                </table>
                            </div>
                            <a href="initInsertFunction.htm">Thêm Function Mới</a>
                            <!-- /.table-responsive -->
                        </div>
                        <!-- /.panel-body -->
                    </div>
