        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
                ...
                <div id="page-wrapper">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">Thêm Mới Function</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                        ...
                        <div class="col-lg-8">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-lg-10">
                                        <f:form role="form" action="insertFunction.htm" method="GET" commandName="newFunction" >
                                            <div class="form-group">
                                                <label> Function ID </label>
                                                <f:input path="functionID" readonly="true" class="form-control" />
                                            </div>
                                            <div class="form-group">
                                                <label>Function Name </label>
                                                <f:input path="functionName" class="form-control" />
                                            </div>
                                            <div class="form-group">
                                                <label>Status </label>
