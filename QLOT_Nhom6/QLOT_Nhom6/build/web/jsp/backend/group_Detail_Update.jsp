                                    ...
                                    <tbody>
                                        <c:forEach var="f" items="${Functions}">
                                            <tr class="odd gradeX">
                                                ...
                                                <td>${f.status}</td>
                                                <td><a href="initUpdateGroup.htm?groupID=${f.functionID}">Update</a>
                                                    <a href="deleteGroup.htm?groupID=${f.functionID}" onclick="return confirm('Are you sure?')">Delete</a></td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
                                </table>
