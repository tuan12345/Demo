                                    ...
                                    <tbody>
                                        <c:forEach var="gr" items="${groups}">
                                            <tr class="odd gradeX">
                                                ...
                                                <td>${gr.groupName}</td>
                                                <td>${gr.status}</td>
                                                <td><a href="initUpdateGroup.htm?groupID=${gr.groupID}">Update</a>
                                                    <a href="initGetFunctionByGroupID.htm?groupID=${gr.groupID}">Detail</a>
                                                    <a href="deleteGroup.htm?groupID=${gr.groupID}" onclick="return confirm('Are you sure?')">Delete</a></td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
                                </table>
                            </div>
                            <a href="initInsertGroup.htm">Add New Group</a>
                            <!-- /.table-responsive -->
                        </div>
                        <!-- /.panel-body -->
                    </div>
