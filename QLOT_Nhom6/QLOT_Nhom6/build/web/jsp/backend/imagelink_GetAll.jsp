        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Website Bán Ôtô</a>
                </div>
                <!-- /.navbar-header -->
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Link Ảnh</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <c:forEach var="il" items="${imagelinks}">
                                            <tr class="odd gradeX">
                                                <td>${il.imageLinkID}</td>
                                                <td>${il.productID}</td>
                                                <td><img width="100px" src="../images/${il.url_before}" /></td>
                                                <td><img width="100px" src="../images/${il.url_behind}"/></td>
                                                <td><img width="100px" src="../images/${il.url_left}"/></td>
                                                <td><img width="100px" src="../images/${il.url_right}"/></td>
                                                <td>${il.status}</td>
                                                <td><a href="initUpdateImageLink.htm?imageLinkID=${il.imageLinkID}">Update</a>       
                                                    <a href="deleteImageLink.htm?imageLinkID=${il.imageLinkID}" onclick="return confirm('Bạn Có Muốn Xía link ảnh này?')">Delete</a></td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
                                </table>
                            </div>
                            <a href="initInsertImageLink.htm">Thêm Ảnh Mới</a>
                            <!-- /.table-responsive -->
                        </div>
                        <!-- /.panel-body -->
                    </div>
