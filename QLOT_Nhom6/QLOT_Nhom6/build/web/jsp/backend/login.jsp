            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    ...
                    <div class="panel-body">
                        <f:form action="TaiKhoan.htm" method="GET" >
                            <fieldset>
                                    ...
                                    <!-- Change this to a button or input when using this as a form -->
                                     <button type="submit" class="btn btn-default btn-lg btn-success btn-block">Login</button>
                                   <!-- <a href="login.htm" class="btn btn-lg btn-success btn-block">Login</a>-->
