                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <c:forEach var="pm" items="${paymentTypes}">
                                            <tr class="odd gradeX">
                                                <td>${pm.paymentTypeID}</td>
                                                <td>${pm.paymentTypeName}</td>
                                                <td>${pm.description}</td>
                                                <td>${pm.status}</td>
                                                <td><a href="initUpdatePaymentType.htm?paymentTypeID=${pm.paymentTypeID}">Update</a>
                                                    <a href="deletePaymentType.htm?paymentTypeID=${pm.paymentTypeID}" onclick="return confirm('Are you sure?')">Delete</a></td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
                                </table>
                            </div>
                            <a href="initInsertPaymentType.htm">Add New PaymentType</a>
                            <!-- /.table-responsive -->
                        </div>
                        <!-- /.panel-body -->
                    </div>
