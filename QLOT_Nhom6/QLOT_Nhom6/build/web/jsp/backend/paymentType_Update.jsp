        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
                ...
                <div id="page-wrapper">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">Sửa PaymentType</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                        ...
                        <div class="col-lg-6">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    Thông Tin PaymentType
                                </div>
                                <!-- /.panel-heading -->
                                <div class="panel-body">
                                <f:form role="form" action="updatePaymentType.htm" method="GET" commandName="updatePaymentType" >
                                    <div class="form-group">
                                        <label>PaymentType ID</label>
                                        <f:input path="paymentTypeID" readonly="true" class="form-control" />
                                    </div>
                                    <div class="form-group">
                                        <label>PaymentType Name</label>
                                        <f:input path="paymentTypeName" class="form-control" />
                                    </div>
                                    <div class="form-group">
