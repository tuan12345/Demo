                                    ...
                                    <tbody>
                                        <c:forEach var="product" items="${products}">
                                            <tr class="odd gradeX">
                                                ...
                                                <td><img width="100px" src="../images/${product.image}"/></td>
                                                ...
                                                <td>${product.numberOfSeat}</td>
                                                <td>${product.carType}</td>
                                                <td>${product.numberView}</td>
                                                <td>${product.yearOfManufacture}</td>
                                                <td>${product.petrolTankCapacity}</td>
                                                <td>${product.timeSpeed100}</td>
                                                <td><a href="initUpdateProduct.htm?productID=${product.productID}">Update</a>       
                                                    <a href="deleteProduct.htm?productID=${product.productID}" onclick="return confirm('Are you sure?')">Delete</a></td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
                                </table>
                            </div>
                            <a href="initInsertProduct.htm">Thêm Sản Phẩm Mới</a>
                            <!-- /.table-responsive -->
                        </div>
                        <!-- /.panel-body -->
                    </div>
