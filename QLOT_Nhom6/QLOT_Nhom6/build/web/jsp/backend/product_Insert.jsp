...
<html lang="en">
    ...
    <head>
        ...
        <link href="/QLOT_Nhom6/jsp/vendor/datatables-responsive/dataTables.responsive.css" rel="stylesheet">
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Website Oto</a>
                </div>
                <!-- /.navbar-header -->
                    ...
                    <div class="col-lg-6" style="height: 100%">
                        <f:form role="form" action="insertProduct.htm" method="POST" modelAttribute="newProduct" enctype="multipart/form-data" >
                            ...
                            <div class="form-group">
                                ...
                                <f:textarea path="contentDetail" class="form-control" rows="4"></f:textarea>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <f:input path="priceImport" type="number" step="0.01" class="form-control" />
                            </div>
                            <div class="form-group">
                                <label>Giá Xuất</label>
                                <f:input path="priceExport" type="number" step="0.01" class="form-control" />
                            </div>
                            <div class="form-group">
                                <label>Khuyến mãi</label>
                                <f:input path="discount" type="number" step="0.01" class="form-control" />
                            </div>
                            <div class="form-group">
                                <label>Ngày Bắt Đầu</label>
                                <f:input path="fromDate" type="date" class="form-control" />
                            </div>
                            <div class="form-group">
                                <label>Ngày Kết Thúc</label>
                                <f:input path="toDate" type="date" class="form-control" />
                            </div>
                            <div class="form-group">
                                <label>Số Lượng </label>
                                <f:input path="quantity" type="number" class="form-control" />
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <f:select path="catalogID" class="form-control">
                                    <c:forEach var="catalog" items="${catalogs}">
                                        <f:option  value="${catalog.catalogID}" label="${catalog.catalogName}"/>
                                    </c:forEach>
                                </f:select>
                            </div>
                            <div class="form-group">
                                <label>Lượt View</label>
                                <f:input path="numberView" type="number" class="form-control" />
                            </div>
                            <div class="form-group">
                                <label>Số Ghế</label>
                                <f:input path="numberOfSeat" type="number" class="form-control" />
                            </div>
                            <div class="form-group">
                                <label>Năm SX</label>
                                <f:input path="yearOfManufacture" type="number" class="form-control" />
                            </div>
                            <div class="form-group">
                                <label>Bình Xăng(lít)</label>
                                <f:input path="petrolTankCapacity" type="number" step="0.01" class="form-control" />
                            </div>
                            <div class="form-group">
                                <label>Thời Gian 100km Đầu </label>
                                <f:input path="timeSpeed100" type="number" step="0.01" class="form-control" />
                            </div>
