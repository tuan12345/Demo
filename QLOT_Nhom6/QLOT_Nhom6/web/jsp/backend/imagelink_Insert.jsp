        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
                ...
                <div id="page-wrapper">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">Thêm link Ảnh Mới</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                                    ...
                                    <div class="row">
                                        ...
                                        <f:form role="form" action="insertImageLink.htm" method="POST" modelAttribute="newImageLink" enctype="multipart/form-data" >
                                            <div class="form-group">
                                                <label>Mã Ảnh</label>
                                                <f:input path="imageLinkID" readonly="true" class="form-control" />
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <f:input  type="file" path="url_before" class="form-control" />
                                            </div>
                                            <div class="form-group">
                                                <label>Ảnh Sau</label>
                                                <f:input  type="file" path="url_behind" class="form-control" />
                                            </div>
                                            <div class="form-group">
                                                <label>Ảnh Trái</label>
                                                <f:input  type="file" path="url_left" class="form-control" />
                                            </div>
                                            <div class="form-group">
                                                <label>Ảnh Phải</label>
                                                <f:input  type="file" path="url_right" class="form-control" />
                                            </div>
                                            <div class="form-group">
