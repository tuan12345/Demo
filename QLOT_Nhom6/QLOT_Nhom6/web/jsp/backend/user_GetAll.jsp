                                    ...
                                    <tbody>
                                        <c:forEach var="us" items="${users}">
                                            <tr class="odd gradeX">
                                                ...
                                                <td>${us.userType}</td>
                                                <td>${us.groupID}</td>
                                                <td><a href="initUpdateUser.htm?userID=${us.userID}">Update</a>
                                                    <a href="deleteUser.htm?userID=${us.userID}" onclick="return confirm('Are you sure?')">Delete</a></td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
                                </table>
                            </div>
                            <a href="initInsertUser.htm">Thêm Người Dùng Mới</a>
                            <!-- /.table-responsive -->
                        </div>
                        <!-- /.panel-body -->
                    </div>
