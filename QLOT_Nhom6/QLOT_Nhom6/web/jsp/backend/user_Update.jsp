                        ...
                        <div class="col-lg-8">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-lg-10">
                                        <f:form role="form" action="updateUser.htm" method="GET" commandName="updateUser" >
                                            <div class="form-group">
                                                <label>Mã Người Dùng </label>
                                                <f:input path="userID" readonly="true" class="form-control" />
                                            </div>
                                            <div class="form-group">
                                                <label>Ten Người Dùng </label>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <f:select path="gender" class="form-control">
                                                    <f:option  value="true" label="Nam"/>
                                                    <f:option value="false" label="N?"/>
                                                </f:select>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <f:input path="userType" class="form-control" />
                                            </div>
                                            <div class="form-group">
                                                <label>Mã Nhóm </label>
                                                <f:input path="groupID" type="number" class="form-control" />
                                            </div>
